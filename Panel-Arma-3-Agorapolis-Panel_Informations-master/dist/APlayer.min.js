! function(e, a) {
  "object" == typeof exports && "object" == typeof module ? module.exports = a() : "function" == typeof define && define.amd ? define("APlayer", [], a) : "object" == typeof exports ? exports.APlayer = a() : e.APlayer = a()
}(this, function() {
  return function(e) {
    function a(l) {
      ...
      n = function() {
        function e(a) {
          ...
          if (this.playIndex = "[object Array]" === Object.prototype.toString.call(a.music) ? 0 : -1, this.option = a, this.audios = [], this.mode = a.mode, this.secondToTime = function(e) {
              ...
              return e >= 3600 ? a(r) + ":" + a(i) + ":" + a(l) : a(t) + ":" + a(l)
          ...
          m.barWrap = this.element.getElementsByClassName("aplayer-bar-wrap")[0], this.option.narrow && this.element.classList.add("aplayer-narrow"), this.button = this.element.getElementsByClassName("aplayer-button")[0], this.button.addEventListener("click", function(e) {
            ...
            for (var e = n.element.getElementsByClassName("aplayer-list")[0].getElementsByTagName("li"), a = function(a) {
                e[a].addEventListener("click", function() {
                  ...
                  t !== n.playIndex ? (n.setMusic(t), n.play()) : n.toggle()
                })
          ...
          m.barWrap.addEventListener("click", function(e) {
            ...
            isNaN(n.audio.duration) ? n.updateBar("played", 0, "width") : (n.updateBar("played", l, "width"), n.element.getElementsByClassName("aplayer-ptime")[0].innerHTML = n.secondToTime(l * n.audio.duration), n.audio.currentTime = parseFloat(m.playedBar.style.width) / 100 * n.audio.duration)
          ...
          var g = function(e) {
            ...
            b = function E() {
              document.removeEventListener("mouseup", E), document.removeEventListener("mousemove", g), isNaN(n.audio.duration) ? n.updateBar("played", 0, "width") : (n.audio.currentTime = parseFloat(m.playedBar.style.width) / 100 * n.audio.duration, n.playedTime = setInterval(function() {
        ...
        return r(e, [{
          ...
          value: function(e) {
            ...
            this.music = this.multiple ? this.option.music[t] : this.option.music, this.music.pic && (this.element.getElementsByClassName("aplayer-pic")[0].style.backgroundImage = "url('" + this.music.pic + "')"), this.element.getElementsByClassName("aplayer-title")[0].innerHTML = this.music.title, this.element.getElementsByClassName("aplayer-author")[0].innerHTML = " - " + this.music.author, this.multiple && (this.element.getElementsByClassName("aplayer-list-light")[0] && this.element.getElementsByClassName("aplayer-list-light")[0].classList.remove("aplayer-list-light"), this.element.getElementsByClassName("aplayer-list")[0].getElementsByTagName("li")[t].classList.add("aplayer-list-light")), this.audio && (this.pause(), this.audio.currentTime = 0), this.multiple && (this.element.getElementsByClassName("aplayer-list")[0].scrollTop = 33 * t), this.multiple && !this.audios[t] || this.playIndex === -1 ? (this.audio = document.createElement("audio"), this.audio.src = this.music.url, this.audio.preload = this.option.preload ? this.option.preload : "auto", this.audio.addEventListener("play", function() {
              if (a.button.classList.contains("aplayer-play")) {
                if (a.button.classList.remove("aplayer-play"), a.button.classList.add("aplayer-pause"), a.button.innerHTML = "", setTimeout(function() {
                    a.button.innerHTML = '\n                                    <button class="aplayer-icon aplayer-icon-pause">' + a.getSVG("pause") + "     </button>"
                  }, 100), a.option.mutex)
                  for (var e = 0; e < i.length; e++) a != i[e] && i[e].pause();
                a.playedTime && clearInterval(a.playedTime), a.playedTime = setInterval(function() {
              ...
              (a.button.classList.contains("aplayer-pause") || a.ended) && (a.ended = !1, a.button.classList.remove("aplayer-pause"), a.button.classList.add("aplayer-play"), a.button.innerHTML = "", setTimeout(function() {
                a.button.innerHTML = '\n                                    <button class="aplayer-icon aplayer-icon-play">' + a.getSVG("play") + "     </button>"
              }, 100), clearInterval(a.playedTime), a.trigger("pause"))
          ...
          value: function() {
            function e(e, a) {
              return null == a && (a = e, e = 0), e + Math.floor(Math.random() * (a - e + 1))
            }

            function a(a) {
              for (var t, l = a.length, r = new Array(l), i = 0; i < l; i++) t = e(0, i), t !== i && (r[i] = r[t]), r[t] = a[i];
              return r
            }
            if (this.multiple) {
              if (!this.normalOrder) {
                this.normalOrder = [];
                for (var t = 0; t < this.option.music.length; t++) this.normalOrder[t] = t
              }
    ...
    function p(e, a) {
      ...
      } else e.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (t = s(a), l = u.bind(null, t), r = function() {
