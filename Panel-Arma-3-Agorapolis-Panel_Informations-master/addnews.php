...
if ($_SESSION['grade'] == 'Harsh'){
    ...
    if(isset($_POST['submit']))
       ...
       if(!empty($_POST['titre']))
       {
          ...
          $img = htmlspecialchars(trim($_POST['img']));
    			$addarticle = $bdd->prepare('INSERT INTO news(titre, date_p, img, auteur, contenu) VALUES(?, ?, ?, ?, ?)');
    			$addarticle->execute(array($titre, $date_p, $img, $auteur, $contenu));
 ...
 ?>
    <div class="content-wrapper">
			<h1>Ajouter un nouvel article au journal officiel</h1>
      <div class="col-md-12">
                     ...
                     <div class="panel-body">
                      <form method="POST" class="form-horizontal">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-lg-10">
                                 <input name="img" type="text" placeholder="Lien de l'image de couverture à fournir sous la forme .jpg à la fin du lien" class="form-control">
                              </div>
                           </div>
