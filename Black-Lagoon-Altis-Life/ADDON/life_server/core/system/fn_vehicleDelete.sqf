...
[[[_sp,_type],{life_atmcash = life_atmcash + (_this select 0); hint format["Du hast das Fahrzeug für $%1 verkauft.",[(_this select 0)] call life_fnc_numberText];}],"BIS_fnc_call",_unit,false] spawn life_fnc_MP;
