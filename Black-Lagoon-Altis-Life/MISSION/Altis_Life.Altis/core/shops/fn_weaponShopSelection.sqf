	...
	else
{
	...
	{
		_priceTag ctrlSetStructuredText parseText format ["<t size='0.8'>Preis: <t color='#ff0000'>$%1</t><br/>Du benötigst noch: <t color='#8cff9b'>$%2</t></t>",[(_price)] call life_fnc_numberText,[(_price - life_cash)] call life_fnc_numberText];
	}
		else
	{
		_priceTag ctrlSetStructuredText parseText format ["<t size='0.8'>Preis: <t color='#8cff9b'>$%1</t></t>",[(_price)] call life_fnc_numberText];
