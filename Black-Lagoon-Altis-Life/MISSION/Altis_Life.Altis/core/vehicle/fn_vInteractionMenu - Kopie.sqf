...
if(!dialog) then {
	createDialog "vInteraction_Menu"; //Use pInteraction_Menu with more buttons
};
...
if(playerSide == west) then {
	...
	//#2
	_Btn6 ctrlSetText localize "STR_vInAct_putToGarage";
	_Btn6 buttonSetAction "[life_vInact_curTarget] spawn life_fnc_putToGarage;";
} else {
	//#2
